...
class TweetAnalzer():
    ...
    def analayze_sentiment(self, tweet):
...
if __name__ == "__main__":
    ...
    tweets = api.user_timeline(screen_name='Arsenal', count=200)
    df = tweet_analayzer.tweets_to_data_frame(tweets)
    df['sentiment'] = np.array([tweet_analayzer.analayze_sentiment(tweet) for tweet in df['tweets']])
